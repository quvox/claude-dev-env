...
verified:
  ...
  against:
    ...
    - {doc: docs/02-design/relations.md, version: 1.11.1}
---
...
**差分なし**(**2026-08-19 の `task-stop-cleanup-and-project-env` 反映後に再確認**。同タスクは
