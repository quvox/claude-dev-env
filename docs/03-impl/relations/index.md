...
| [MODULE-cli-common-spawned-resources](MODULE-cli-common-spawned-resources.md) | MOD-cli-common | function-call | sync | MODULE-cli-reset, MODULE-cli-stop | なし | セッション由来の資源を種別とラベルフィルタ式から名前で列挙する |
...
| [MODULE-cli-logout](MODULE-cli-logout.md) | MOD-cli-logout | tool | sync | なし | MODULE-cli-common-container-exists, MODULE-cli-common-destructive, MODULE-cli-common-lock, MODULE-cli-common-net-other-running-containers, MODULE-cli-common-require-setup | Claude と Codex の認証情報を共有ボリュームごと削除する |
