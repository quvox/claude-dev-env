...
|---|---|---|---|---|---|
| [cli-attach](cli-attach.md) | MOD-cli-attach | 0 / **1** / 0 | 1.1.1 | 2026-08-12 | MOD-cli-attach(実行中コンテナへの接続)の受入基準⇄テスト対応 |
| [cli-code](cli-code.md) | MOD-cli-code | 0 / **1** / 0 | 1.1.1 | 2026-08-12 | MOD-cli-code(tmux ウィンドウでの Claude Code 起動)の受入基準⇄テスト対応 |
...
| [e2e](e2e.md) | E2E | 0 / **4** / 0 | 1.18.0 | 2026-08-22 | E2Eシナリオ E2E-01〜E2E-03 と E2E-06 ⇄ テスト対応 |
| [entrypoint](entrypoint.md) | MOD-entrypoint | 0 / **27** / 0 | 1.4.0 | 2026-08-22 | MOD-entrypoint(コンテナ起動シーケンス)の受入基準⇄テスト対応 |
| [firewall](firewall.md) | MOD-firewall | 0 / **5** / 0 | 1.2.1 | 2026-08-12 | MOD-firewall(外向き通信のブラックリスト適用)の受入基準⇄テスト対応 |
| [images](images.md) | (モジュール外)イメージのビルドと GHCR 配布 | 0 / **22** / 0 | 1.5.0 | 2026-08-22 | どのモジュールにも属さないイメージのビルドと GHCR 配布の受入基準⇄テスト対応 |
