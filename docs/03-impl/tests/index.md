...
| [cli-common](cli-common.md) | MOD-cli-common | 0 / **16** / 1 | 1.0.0 | 2026-08-03 | MOD-cli-common(CLI 共有基盤の11関数)の受入基準⇄テスト対応 |
| [cli-firewall](cli-firewall.md) | MOD-cli-firewall | 0 / **1** / 2 | 1.0.0 | 2026-08-03 | MOD-cli-firewall(ファイアウォール状態の表示)の受入基準⇄テスト対応 |
| [cli-forward](cli-forward.md) | MOD-cli-forward | 0 / **6** / 1 | 1.0.0 | 2026-08-03 | MOD-cli-forward(ポートフォワードの追加)の受入基準⇄テスト対応 |
...
| [cli-logout](cli-logout.md) | MOD-cli-logout | 0 / **2** / 1 | 1.0.0 | 2026-08-03 | MOD-cli-logout(認証情報の破棄)の受入基準⇄テスト対応 |
...
| [cli-pull](cli-pull.md) | MOD-cli-pull | 0 / **3** / 1 | 1.0.0 | 2026-08-03 | MOD-cli-pull(GHCR からのイメージ取得)の受入基準⇄テスト対応 |
...
| [cli-unforward](cli-unforward.md) | MOD-cli-unforward | 0 / **2** / 1 | 1.0.0 | 2026-08-03 | MOD-cli-unforward(ポートフォワードの解除)の受入基準⇄テスト対応 |
...
| [orchestrator](orchestrator.md) | MOD-orchestrator | 35 / **40** / 0 | 1.0.1 | 2026-08-03 | MOD-orchestrator(AIオーケストレーター)の受入基準⇄テスト対応 |
...
| [strategy](strategy.md) | 全体 | - | 1.0.0 | 2026-08-03 | テストのレベル別実行方法・状態列の語彙・受入基準の配分規約 |
