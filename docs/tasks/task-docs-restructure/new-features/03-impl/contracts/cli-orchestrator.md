...
sections: []
deletes: []
reason: 02-design と同一 ID の契約を実装側にも置く。生存判定の方法と設定キーの一覧は実装が事実であり、復旧の振る舞い(AC-05)を追跡するために固定する。
---

<!-- change: add。id: cli-orchestrator / kind: other /
     impl: claude-dev::main#orchestrate / source: docs/02-design/contracts/cli-orchestrator.md -->
