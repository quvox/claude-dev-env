---
target: docs/03-impl/contracts/entrypoint-firewall.md
change: add
sections: []
deletes: []
reason: 02-design と同一 ID の契約を実装側にも置く。「失敗を握りつぶして起動を続ける」という実装の事実を、呼び出し行つきで残すため。
---

<!-- change: add。id: entrypoint-firewall / kind: other /
     impl: scripts/entrypoint-claude.sh::main / source: docs/02-design/contracts/entrypoint-firewall.md -->
