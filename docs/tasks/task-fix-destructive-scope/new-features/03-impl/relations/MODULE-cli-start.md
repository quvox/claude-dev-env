...
sections:
  ...
  - "## 実装上の判断"
deletes: []
reason: D0-env-08 の管理ラベルの付与側であり、項6 の排他(プロジェクト単位と、認証コピーから docker run 完了までの共有資源単位)と項7 の compose プロジェクト名の一意化を担う(FR-env-01 受入基準 14・16〜19。docs/issues/020 / 024 / 045)
id: MODULE-cli-start
